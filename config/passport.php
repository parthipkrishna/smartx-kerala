...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | This configuration value allows you to customize the Time
    | for Passport, such as the database connection that should be used
    |
    */

    'personal_access_token_expires_in' => 120, // 3 days in seconds
    'refresh_token_expires_in' => 2628000, // 1 month in seconds
