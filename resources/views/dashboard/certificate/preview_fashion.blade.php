...
@section('preview-certificate-fashion')
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="container-fluid">
                            <div class="divMain">
                                <img class="img-fluid image-1" src="{{ asset('assets/images/07.PNG') }}" alt="">
                                <div class="" style="display: flex;gap: 20px;align-items: end; border-bottom: 2px solid #f1848d;padding: 0px 0px 4px 30px;width: 100% !important;margin-left: -40px;">
                                    <div class="">
                                        <img class="img-fluid Kifd-img" src="{{ asset('assets/images/09.PNG') }}" alt="">
                                        <h2>Kerala Institute Of Fashion Designing<br>VOCATIONAL TRAINING ORGANIZATION</h2>
                                    </div>
                                    <div class="line" style="background-color: #f1848d;"></div>
                                    <div class="">
                            ...
                            <div class="d-flex gap-4">
                                ...
                                <div class="">
                                    <div class="" style="display: flex; align-items: end; gap: 104px; width: 100% !important;margin-top: 35px; margin-left: 15%;">
                                        ...
                                        <h3>Reg. No. KIFD - {{ $certificate->register_no  }}</h3>
                                    </div>
                                    <div class="certificate-text " style="margin: 2rem 6rem 2rem 0rem;">                        
                                        The Academic Council of KIFD (Kerala Institute of Fashion Designing), “Vocational Training Organization” having duly examined 
                                        <strong><span style="color:rgb(211, 5, 5)">{{ $certificate->student_name }}</span></strong> during and after <strong>{{ $certificate->duration }}</strong> months
                                        ...
                                        advanced certificate in <strong><span style="color:rgb(211, 5, 5)">{{ $course->name }}</span>, </strong> 
                            ...
                            <div class="d-flex">
                                ...
                                <img class="img-fluid image-6 mt-2" src="{{ asset('assets/images/06.PNG') }}" alt="">
                                <div class="">
