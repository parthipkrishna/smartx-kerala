...
@section('view-marklist-theme') 
    ...
    <script>
        function openPDF() {
            window.open("{{ asset('pdf/marklist1.pdf') }}", "_blank");
        }
    </script>
    <script>
        function openPDF2() {
            window.open("{{ asset('pdf/marklist2.pdf') }}", "_blank");
        }
    </script>
