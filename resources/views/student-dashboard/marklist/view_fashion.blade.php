            ...
            <div class="card-body">
                    ...
                    <div class="col-sm-7">
                        <div class="text-sm-end">
                            <div class="col-12 d-flex justify-content-end">
                                <button id="downloadPDF" class="btn btn-secondary m-3">Download PDF</button>
                            </div>
                        </div>
                    </div><!-- end col -->
                </div>
                <section class="main-section">
                    <div class="container-fluid">
                        <div class="row">
                        <img class="img-fluid" src="{{ asset('assets/images/Banner2.png') }}" alt="">
                    ...
                    <div class="mt-3">
                        <div class="heading">
                            <div class="siNo">
                                <h6 style="margin-top: 0px;margin-left: 17px;">SI.NO.</h6>
                            </div>
                            <div class="syllabus">
                                <h6 style="margin-top: 0px;">SYLLABUS</h6>
                            </div>
                        </div>
                        {{-- <div class="logo-img">
                            <div class="line"></div>
                        ...
                        <div class="rows">
                            ...
                            <footer>
                                <div class="isoDev">
                                    <p>Prepared By</p>
                                    <img class="img-fluid" src="{{ asset('assets/images/iso-img-kifd.png') }}" alt="">
                                    <p>Registrar</p>
                                </div>
